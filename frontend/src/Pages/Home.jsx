...
import { Github, Linkedin, Mail, ExternalLink, Sparkles, Code } from "lucide-react"
...
const WORDS = ["Full-Stack Developer", "Software Engineer", "Competitive Programmer"];
const TECH_STACK = ["Spring Boot", "React", "Docker", "PostgreSQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/utkarshjain45" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/utkarshjain45" },
  { icon: Code, link: "https://leetcode.com/u/utkarshjain45" }
];
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="mx-auto px-[5%] sm:px-6 lg:px-[10%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen pt-28 pb-16 lg:pt-20 lg:pb-20 md:justify-between gap-4 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Designing scalable backend architectures and interactive user experiences for digital solutions.
                </p>
